    ...
    <div class="container ">
        <form action="createAcct.php" method="POST">
            <div class="form-group">
                ...
                <input type="text" class="form-control col-sm-4" name="txtName" id="txtName"><br>

                <label for="password" class="form-group">Password</label>
                <input type="password" class="form-control col-sm-4" name="txtPassword" id="txtPassword"><br>
